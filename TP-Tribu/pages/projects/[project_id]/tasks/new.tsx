...
export default function NewTask() {
    ...
    const submit = async () => {
        ...
        await fetch(`${backHost.project}/tasks/`, {
            method: 'POST',
                    ...
                    <div className="fixed text-black inset-0 flex w-screen items-center justify-center p-4">
                        <DialogPanel className="max-w-lg space-y-6  border border-black rounded-lg bg-white p-8 colors_layout_background_tasks">
                            ...
                            <div className="w-full flex flex-row space-x-10">
                                ...
                                <Link className="w-1/2 colors_button_alt flex justify-center h-8 rounded-md border border-black" href={{ pathname: `/projects/${project_id}/tasks` }}>
    ...
    return (
        <div className="colors_background_task w-full h-full flex-col flex place-content-center items-center text-black">
            <ConfirmGoBackDialog />
            <div className="colors_header_task text-white w-5/12 rounded-t-lg pl-1 text-xl border-black border-t border-r border-l">Create task</div>
            <div className="colors_layout_background_tasks w-5/12 flex-col flex px-4 py-3 justify-center rounded-b-lg border-black border">
                ...
                <label className="text-xl font-medium pb-1 leading-6 text-gray-900 ">Select a start date*</label>
                ...
                <label className="text-xl font-medium leading-6 pb-1 pt-2 text-gray-900 ">Select a deadline*</label>
                <div className="w-6/12 flex-row flex place-items-start">
                ...
                <div className=" flex-col flex justify-center w-6/12 place-items-start">
                    <label className="text-xl font-medium whitespace-nowrap pb-1 pt-2 leading-6 text-gray-900">Select a priority*</label>
                    <div className="w-full">
                ...
                <div className="flex-row flex w-6/12 h-8 mt-2 space-x-4 place-self-end">
                    <Button onClick={handleSubmit} className="flex place-items-center justify-center w-full colors_button_tasks h-full rounded border border-black ">
                        {showLoad ? <img className=" h-full" src={"https://media.tenor.com/_62bXB8gnzoAAAAj/loading.gif"} alt="loading..." /> : "Submit new task"}
                    </Button>
